...
export async function GET(_request: Request, { params }: Params) {
  try {
    ...
    return jsonResult(await backendFetch(`/establishments/${id}`));
  } catch (error) {
...
export async function PATCH(request: Request, { params }: Params) {
  try {
    ...
    return jsonResult(
      await backendFetch(`/establishments/${id}`, { method: "PATCH", body }),
    );
  } catch (error) {
    return errorResponse(error);
  }
...
export async function DELETE(_request: Request, { params }: Params) {
  try {
    const { id } = await params;
    return jsonResult(
      await backendFetch(`/establishments/${id}`, { method: "DELETE" }),
    );
  } catch (error) {
    return errorResponse(error);
  }
